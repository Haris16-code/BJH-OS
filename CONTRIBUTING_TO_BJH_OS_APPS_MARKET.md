...
- You can set your app as **paid** and assign a **point cost**. When a user downloads the app, the points are **deducted from their account** and **credited to your account**. You will also receive a **notification** for each purchase.  

  *(Note: It’s recommended to start with free apps, since most users prefer them. Only set your app as paid if you are confident it offers exceptional value and will truly impress users.)*
